...
class RegionManager(CollectorManager):
    _region_info = {
    ...
    def collect(self, options, secret_data, schema, task_options):
        '''
        this function should return metadata of regions.
        '''
        pass


    def get_region_info_by_name(self, region):
        return self._region_info[region]

    def get_region_names(self):
        return list(self._region_info.keys())
